...
import (
	...
	meshsecuritytypes "github.com/osmosis-labs/mesh-security-sdk/x/meshsecurity/types"
...
type TestKeepers struct {
	...
	MeshKeeper         *meshsecuritykeeper.Keeper
	MeshProviderKeeper *Keeper
	AccountKeeper      authkeeper.AccountKeeper
	WasmKeeper         *wasmkeeper.Keeper
	Faucet             *wasmkeeper.TestFaucet
}

func CreateDefaultTestInput(t testing.TB, opts ...meshsecuritykeeper.Option) (sdk.Context, TestKeepers) {
	db := dbm.NewMemDB()
	...
	keys := sdk.NewKVStoreKeys(
		...
		wasmtypes.StoreKey, meshsecuritytypes.StoreKey, types.StoreKey,
	)
	for _, v := range keys {
		ms.MountStoreWithDB(v, storetypes.StoreTypeIAVL, db)
	}
	memKeys := sdk.NewMemoryStoreKeys(capabilitytypes.MemStoreKey, meshsecuritytypes.MemStoreKey)
	...
	msKeeper := meshsecuritykeeper.NewKeeper(
		appCodec,
		keys[meshsecuritytypes.StoreKey],
		memKeys[meshsecuritytypes.MemStoreKey],
		bankKeeper,
		stakingKeeper,
		wasmKeeper,
		authority,
	...
	require.NoError(t, msKeeper.SetParams(ctx, meshsecuritytypes.DefaultParams(sdk.DefaultBondDenom)))

	msProvKeeper := NewKeeper(
		appCodec,
		keys[types.StoreKey],
		authority,
		bankKeeper,
	...
	return ctx, TestKeepers{
		...
		MeshKeeper:         msKeeper,
		MeshProviderKeeper: msProvKeeper,
