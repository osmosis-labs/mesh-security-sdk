...
func NewKeeper(cdc codec.Codec, storeKey storetypes.StoreKey, account types.AccountKeeper, bank types.SDKBankKeeper, staking types.SDKStakingKeeper, authority string) *Keeper {
	return NewKeeperX(cdc, storeKey, account, NewBankKeeperAdapter(bank), NewStakingKeeperAdapter(staking, bank), authority)
}

// NewKeeperX constructor with extended Osmosis SDK keepers
func NewKeeperX(cdc codec.Codec, storeKey storetypes.StoreKey, accountKeeper types.AccountKeeper, bank types.XBankKeeper, staking types.XStakingKeeper, authority string) *Keeper {
