...
func (k Keeper) SendValsetUpdate(ctx sdk.Context, contractAddr sdk.AccAddress, v bindings.ValsetUpdate) error {
	msg := bindings.SudoMsg{
		ValsetUpdate: &v,
	}
	return k.doSudoCall(ctx, contractAddr, msg)
...
func (k Keeper) doSudoCall(ctx sdk.Context, contractAddr sdk.AccAddress, msg bindings.SudoMsg) error {
