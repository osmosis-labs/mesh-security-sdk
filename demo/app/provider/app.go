...
var (
	_ runtime.AppI            = (*MeshProviderApp)(nil)
	_ servertypes.Application = (*MeshProviderApp)(nil)
)

// MeshProviderApp extended ABCI application
type MeshProviderApp struct {
	*baseapp.BaseApp
...
func NewMeshProviderApp(
	...
	app.SlashingKeeper = slashingkeeper.NewKeeper(
		...
		meshsecprovkeeper.NewStakingDecorator(app.StakingKeeper, app.MeshSecProvKeeper),
		authtypes.NewModuleAddress(govtypes.ModuleName).String(),
	)
...
func (app *MeshProviderApp) setAnteHandler(txConfig client.TxConfig, wasmConfig wasmtypes.WasmConfig, txCounterStoreKey storetypes.StoreKey) {
...
func (app *MeshProviderApp) setPostHandler() {
...
func (app *MeshProviderApp) Name() string { return app.BaseApp.Name() }
