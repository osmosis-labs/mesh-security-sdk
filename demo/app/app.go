...
func NewMeshApp(
	...
	*/
	...
	// just adding the keeper here to compile for now
	_ = meshsecuritykeeper.NewKeeper(appCodec, keys[meshsecuritytypes.StoreKey], app.AccountKeeper, app.BankKeeper, app.StakingKeeper, authtypes.NewModuleAddress(govtypes.ModuleName).String())
