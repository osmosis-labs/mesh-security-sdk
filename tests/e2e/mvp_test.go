...
func TestMVP(t *testing.T) {
	...
	contrApp := controllerChain.App.(*app.MeshApp)
	icaRsp, err := contrApp.ICAControllerKeeper.InterchainAccount(sdk.WrapSDKContext(controllerChain.GetContext()), &icacontrollertypes.QueryInterchainAccountRequest{
